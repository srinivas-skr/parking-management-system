            ...
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-white focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary"
                >
