...
# Copy Maven files first for better caching (from parkease-backend folder)
COPY parkease-backend/pom.xml .
RUN mvn dependency:go-offline -B

# Copy source and build
COPY parkease-backend/src ./src
